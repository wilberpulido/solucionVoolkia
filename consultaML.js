...
fetch(`https://api.mercadolibre.com/orders/search/pending?seller=${seller_id}&site_id=$MLA`)
    ...
    // Dado que no he trabajado generando archivos.log y por motivos de tiempo, decidi realizar el script imprimiento los resultados por consola, es decir, sin generar
    //un archivo.log. Para generar un archivo que registre la respuesta, tengo un metodo que explicare al final.
